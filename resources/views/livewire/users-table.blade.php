                ...
                <div class="flex items-center justify-between d p-4">
                    ...
                    <div class="flex space-x-3">
                        <div class="flex space-x-3 items-center">
                            <label class="w-40 text-sm font-medium text-gray-900">{{__("User Type") }} :</label>
                            <select
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                @include('livewire.inc.table-sort-th', [
                                    'name' => 'name',
                                    'displayName' => 'Name'
                                ])
                                @include('livewire.inc.table-sort-th', [
                                ...
                                <th scope="col" class="px-4 py-3">{{__("Last update") }}</th>
                        ...
                        <tbody>
                            ...
                            <tr wire:key="{{ $user->id }}"
                                ...
                                <td class="px-4 py-3 {{ $user->is_admin ? 'text-green-500' : 'text-blue-500' }}">
                                    {{ $user->is_admin ? {{__("Admin") }} :  {{__("Member") }} }}</td>
